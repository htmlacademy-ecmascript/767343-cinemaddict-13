...
/* harmony import */ var _view_profile_rating_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./view/profile-rating.js */ "./src/view/profile-rating.js");
...
/* harmony import */ var _view_top_rated_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./view/top-rated.js */ "./src/view/top-rated.js");
/* harmony import */ var _view_most_commented_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./view/most-commented.js */ "./src/view/most-commented.js");
...
render(siteHeaderElement, Object(_view_profile_rating_js__WEBPACK_IMPORTED_MODULE_0__["createProfileRatingTemplate"])(), `beforeend`);

render(siteMainElement, Object(_view_menu_js__WEBPACK_IMPORTED_MODULE_1__["createMenuTemplate"])(), `beforeend`);

render(siteMainElement, Object(_view_films_js__WEBPACK_IMPORTED_MODULE_2__["createFilmsTemplate"])(), `beforeend`);
const siteFilmsContainer = siteMainElement.querySelector(`.films-list__container`);
const renderFilmsTemplate = () => {
  for (let i = 0; i < FILM_COUNT; i++) {
    render(siteFilmsContainer, Object(_view_film_card_js__WEBPACK_IMPORTED_MODULE_3__["createFilmCardTemplate"])(), `beforeend`);
  }
};
render(siteFilmsContainer, renderFilmsTemplate(), `beforeend`);

render(siteFilmsContainer, Object(_view_show_more_js__WEBPACK_IMPORTED_MODULE_4__["createShowMoreButtonTemplate"])(), `beforeend`);

render(siteFilmsContainer, Object(_view_top_rated_js__WEBPACK_IMPORTED_MODULE_5__["createTopRatedTemplate"])(), `beforeend`);
render(siteFilmsContainer, Object(_view_most_commented_js__WEBPACK_IMPORTED_MODULE_6__["createMostCommentedTemplate"])(), `beforeend`);
...
const renderExtraFilms = () => {
  for (const element of siteExtraElements) {
    for (let i = 0; i < FILM_EXTRA_COUNT; i++) {
      ...
      render(siteExtraElement, Object(_view_film_card_js__WEBPACK_IMPORTED_MODULE_3__["createFilmCardTemplate"])(), `beforeend`);
    }
  }
};
renderExtraFilms();

render(siteFooterStatsElement, Object(_view_footer_stats_js__WEBPACK_IMPORTED_MODULE_7__["createFooterStatsTemplate"])(), `beforeend`);
render(siteFooterElement, Object(_view_popup_js__WEBPACK_IMPORTED_MODULE_8__["createPopupTemplate"])(), `beforeend`);
...
/***/ "./src/view/profile-rating.js":
/*!************************************!*\
  !*** ./src/view/profile-rating.js ***!
  \************************************/
/*! exports provided: createProfileRatingTemplate */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createProfileRatingTemplate", function() { return createProfileRatingTemplate; });
